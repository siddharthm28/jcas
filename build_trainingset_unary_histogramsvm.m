...
if ((~exist(training_set_svm_filename, 'file') || obj.force_recompute.trainingset_svm)) && isequal(imgsetname,'training')
    ...
    for i=1:obj.dbparams.ncat
        fprintf(sprintf('construct_training_set_for_svm_on_histograms: Collected %d histograms for class %d',num_hists_per_class(i),i));
    end
    fprintf(sprintf('construct_training_set_for_svm_on_histograms: Collected a total of %d histograms',ctr));
