...
addpath(genpath('/Users/bertrand/Documents/MVA/JCaS/JCaSLib/'));
run('/Users/bertrand/Documents/MVA/JCaS/JCaSLib/vlfeat-0.9.16/toolbox/vl_setup');
run('/Users/bertrand/Documents/MVA/JCaS/JCaSLib/blocks/blocks_setup');
disp('Setup done');
...
expJCAS.makedb('Graz1807');
expJCAS.dbparams.imgpath='/Users/Bertrand/Documents/X/Stage3A/DB/GrazImages/';
expJCAS.dbparams.destmatpath='/Users/Bertrand/Documents/MVA/JCaSRes/results/%s.mat';
expJCAS.dbparams.segpath='/Users/Bertrand/Documents/X/Stage3A/DB/GrazOldGT/%s.mat';
expJCAS.dbparams.training   = [1,350,849];
expJCAS.dbparams.test       = [2,351,850];
...
% quantization
expJCAS.unary.dictionary.params.num_bu_clusters                  = 10;
...
expJCAS.optimisation.params.max_iter=20;
